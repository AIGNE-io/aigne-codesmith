...
export const COMMENT_GREETING = `${getInput('bot_icon')} AIGNE CodeSmith`

export const COMMENT_TAG =
  '<!-- This is an auto-generated comment by AIGNE CodeSmith -->'

export const COMMENT_REPLY_TAG =
  '<!-- This is an auto-generated reply by AIGNE CodeSmith -->'
...
export const IN_PROGRESS_END_TAG =
  '<!-- end of auto-generated comment: summarize review in progress by AIGNE CodeSmith -->'
...
export const RAW_SUMMARY_START_TAG = `<!-- This is an auto-generated comment: raw summary by AIGNE CodeSmith -->
<!--
`
export const RAW_SUMMARY_END_TAG = `-->
<!-- end of auto-generated comment: raw summary by AIGNE CodeSmith -->`

export const SHORT_SUMMARY_START_TAG = `<!-- This is an auto-generated comment: short summary by AIGNE CodeSmith -->
<!--
`

export const SHORT_SUMMARY_END_TAG = `-->
<!-- end of auto-generated comment: short summary by AIGNE CodeSmith -->`
